...
% 
% Name of Block: Digital Communications Lab Initializtion
%
% Description: Initializes all necessary values for Lab.
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
delay_cmpnst = 1;               % Delay Compensation
pulse_gen_mode = 'conv';        % Pulse Shaping Mode
rx_type = 'matched_filter';     % Receiver Type ('matched_filter' or 'correlator')
